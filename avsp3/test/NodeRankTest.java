...
public class NodeRankTest {
    ...
    private void run(String input, String expected, String actual) throws IOException {
        ...
        NodeRank.main(new String[]{input}); //run
    ...
    public void btest2() throws Exception {
        ...
        String input = "res/lab3A_primjeri/btest2/R.in";
        String expected = "res/lab3A_primjeri/btest2/R.out";
    ...
    public void mtest2() throws Exception {
        ...
        String input = "res/lab3A_primjeri/mtest2/R.in";
        String expected = "res/lab3A_primjeri/mtest2/R.out";
        String actual = expected + ".my";
        run(input, expected, actual);
    }
    ...
    public void stest2() throws Exception {
        ...
        String input = "res/lab3A_primjeri/stest2/R.in";
        String expected = "res/lab3A_primjeri/stest2/R.out";
        String actual = expected + ".my";
        run(input, expected, actual);
    }
    ...
    public void ttest2() throws Exception {
        ...
        String input = "res/lab3A_primjeri/ttest2/R.in";
        String expected = "res/lab3A_primjeri/ttest2/R.out";
        String actual = expected + ".my";
        run(input, expected, actual);
    }
